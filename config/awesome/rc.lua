...
clientkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "z",  awful.client.floating.toggle                     ,
...
awful.spawn.with_shell("wal -i ~/resources/backgrounds/texas.jpg")
awful.spawn.with_shell("xrandr --auto --output HDMI-0 --right-of DP-5")
awful.spawn.with_shell("xrandr --output HDMI-0 --primary")
